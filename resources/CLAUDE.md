...
│   ├── Wahl des Architekturmodels + Begründung
│   └── zettel/                         [Zettel storage]
...
- **`project/`** contains production code (exactly like GitLab Version)
- **`resources/`** contains all documentation, guides, and learning materials

Milestone 3 (Basic implementation) achieved with Flask backend and table display.

## Important Documentation

All architectural decisions are documented in `resources/wiki/Strategischer-Entwurf/`:
...
Comprehensive Zettelstore API documentation is available in `resources/docs/api/`:
...
Requirements are now tracked in **GitHub Issues**:
- **Repository:** https://github.com/Aphelion-Z/zettelweb/issues
- **Access via CLI:** `gh issue list`
- **Labels:** `functional` (Issues #17-27), `non-functional` (Issues #28-33)

All 17 user stories have been migrated from GitLab CSV to GitHub Issues:
